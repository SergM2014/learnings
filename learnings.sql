...
--
-- Хост: localhost
-- Время создания: Май 22 2017 г., 09:45
-- Версия сервера: 5.7.18-0ubuntu0.16.04.1
-- Версия PHP: 7.0.19-1+deb.sury.org~xenial+1
...
(3, 'p1010024_1495173802.jpg', 'user11', '$2y$10$C2wVmKuWsmqQ8z9i/f5WDe91L.adS6SwBB92dj.R/Fs1opXE/eRNS', 'weisse@ukr.net', 'user', '1', 'user');
...
(1, 'Опис плану підписки  up      ', 'Description plan   up     ');
...
INSERT INTO `categories` (`id`, `title`, `eng_translit_title`) VALUES
(1, 'box22', 'box22'),
(2, 'djiu-djitsu', ''),
(3, 'english', ''),
(4, 'german', ''),
...
(7, 'css', ''),
(8, 'html', ''),
(10, 'to del category', 'errrrrrrrrrrty');
...
(10, 'ftyiftgui updated', 1, 2, 0, '0', '1', '2017-04-01 09:47:18'),
(11, 'qwerty2', 1, 2, 0, '0', '1', '2017-04-06 08:14:12'),
(12, 'this is updated comment', 1, 2, 0, '0', '1', '2017-05-13 08:25:19');
...
INSERT INTO `lessons` (`id`, `title`, `icon`, `category_id`, `serie_id`, `excerpt`, `file`, `free_status`, `added_at`, `updated_at`) VALUES
(1, 'Крок 1 в боксі', 'carrier.gif', 1, 1, 'АБУ почало кримінальне провадження стосовно голови Солом\'янського суду Людмили Шереметьєвої, яка самоусунулася від своїх обов\'язків у справі Романа Насірова і розпустила суд. Тим самим заблокувавши обрання йому запобіжного заходу.', 'lesson1.mp4', '0', '2017-04-01 08:05:44', '2017-04-23 08:06:52'),
(2, 'Крок 2 в боксі', 'ch.gif', 1, 1, 'Про це йдеться у відповіді НАБУ стосовно заяви народних депутатів про кримінальне правопорушення, повідомляє Українська правда.', NULL, '1', '2017-04-02 08:05:44', '2017-04-23 08:07:00'),
(3, 'Японська боротьба', 'daikin.gif', 1, 2, 'Заяву прийнято і за результатами її розгляду в Єдиний реєстр досудових рішень внесено відомості про вчинення злочину та розпочато кримінальне провадження.', NULL, '0', '2017-04-03 08:05:44', '2017-04-23 08:07:06'),
(4, 'Історія англійської', 'fujitsu.gif', 1, 3, 'Раніше група народних депутатів передала в НАБУ заяву про порушення посадових обов\'язків головою суду Солом\'янського району Києва Шереметьєвою.', NULL, '1', '2017-04-04 08:05:44', '2017-04-23 08:07:10'),
(5, 'Німецька в СКСК', 'general_climat.gif', 3, 4, 'У заяві йдеться, що 5 березня Шереметьєва самоусунулася і не виконала свої посадові обов\'язки - не призначила чергового суддю для розгляду клопотання захисту Насірова про відвід судді Олександра Бобровника, який вів засідання про обрання запобіжного заходу відстороненому голові ДФС Насірову.', NULL, '1', '2017-04-05 08:05:44', '2017-04-23 08:07:14'),
(6, 'php7', 'gree.gif', 4, 5, 'Відстороненого голову Державної фіскальної служби України Романа Насирова підозрюють у зловживанні службовим становищем і розкраданні державних коштів в сумі понад 2 млрд грн. Слідство вважає, що Насіров, діючи в інтересах депутата Онищенко, в рамках "газової справи" безпідставно надавав деяким підприємствам можливість податкових зобов\'язань в розстрочку. Насіров вийшов з Лук\'янівського СІЗО під заставу в 100 млн грн.', NULL, '1', '2017-04-06 08:05:44', '2017-04-23 08:07:19'),
(7, 'Погляд на jquery', 'mitsubishi.gif', 5, 6, 'Колишній боєць батальйону «Донбас» Ярослав Левенець, якого у медіа назвали ймовірним фігурантом справи про вбивство екс-депутата російської Держдуми Дениса Вороненкова, зник після допиту в прокуратурі. Про це журналістам повідомила його дружина Ганна, яка вважає, що чоловік не переховується, а зник. Побратими та люди, які його знали раніше, розповідають про Ярослава як про націоналіста, патріота та привітну людину. А у Генеральній прокуратурі поки не коментують, чи він причетний до справи Вороненкова.', NULL, '1', '2017-04-07 08:05:44', '2017-04-23 08:07:24'),
(8, 'Урок css', 'panasonic.gif', 6, 7, 'Ганна, дружина Левенця, повідомила, що за вісім днів до вбивства Дениса Вороненкова, Ярослава затримали на вокзалі, відвезли до поліції, а потім відпустили. А власне у день загибелі екс-депутата Російської Держдуми Левенець поїхав до Києва, адже мав з’явитись у прокуратурі, говорила вона. Об 11-й годині ранку, тобто за півгодини до вбивства, Ганна зв’язалась із чоловіком по телефону.', NULL, '0', '2017-04-08 08:05:44', '2017-04-23 08:07:29'),
(9, 'Html forever', 'toshiba.gif', 7, 8, '«Я не знаю, в якій справі його викликали. Чи то у старій, часів Януковича, чи то щодо затримання на вокзалі. Ми коротко поговорили про дітей, він сказав, що любить. Це була звичайна ніжна розмова. Він сказав, що їде додому», – переказує слова Ганни прес-секретар «Правого сектора» Артем Скоропадський у себе на Фейсбуці.', NULL, '0', '2017-04-09 08:05:44', '2017-04-23 08:07:34'),
(10, 'Невідомі боксери', 'toshiba.gif', 1, NULL, 'Уже ввечері дня, коли відбулось вбивство, телефон Ярослава не відповідав, зв’язку з ним немає. Приятель чоловіка розповів, що Левенець усе ж був на допиті орієнтовно о 16-17-й годині.', 'lesson2.mp4', '1', '2017-04-10 08:05:44', '2017-04-23 08:07:38'),
(11, 'Бокс на початку 20 століття', 'carrier.gif', 1, NULL, 'На кондитерській фабриці «Світоч» встановили нове сучасне обладнання з виробництва вафель відомого європейського виробника. Це вже третя технологічна лінія на фабриці, яку спроектували й виготовили спеціально на замовлення Nestle в Україні.', NULL, '1', '2017-04-11 08:05:44', '2017-04-23 08:07:43'),
(12, 'wwwup', 'carrier.gif', 4, 5, 'wwup', 'lesson1.mp4', '0', '2017-04-12 08:05:44', '2017-04-23 08:07:48');
...
INSERT INTO `series` (`id`, `category_id`, `title`, `eng_translit_title`, `icon`, `upgrading_skill`) VALUES
(1, 1, 'Перші кроки в боксі up3', 'pеrshі krоki v bоksі up3', '1.png', 2),
...
(6, 'bumbum', 2, '1', '0', '2017-03-28 06:58:03'),
(7, 'joip', 2, '1', '0', '2017-04-01 07:12:21'),
(8, 'updated      ', 2, '1', '1', '2017-04-06 05:16:11');
...
(3, 'p1010021_1495173707.jpg', 'superadmin', '$2y$10$ijzbdMcVQrsmgtkl.yMh2elYvglRhm3D4e7H06b57JhmTMJPurDT6', 'weisse@ukr.net', '2012-05-01', NULL, 'superadmintoken'),
